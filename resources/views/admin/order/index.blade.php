...
@section('body')
                    ...
                    <div class="card-body">
                        ...
                        <form name="data_entry_form" class="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" name="product" id="product" required>
                                    </textarea>
                            </div>
                                    ...
                                    <tbody class="print__body">
                                        ...
                                        @foreach ($allOrders as $order)
                                            ...
                                            <tr class="print__tr" data-data="{{ htmlspecialchars($orderData) }}">
                                                ...
                                                <input class="tr_barcode" style="display: none"
                                                    value="{{ $generator->getBarcode($order->invoice, $generator::TYPE_CODE_128) }}">

                                                <td><input type="checkbox" name="invoice_print" class="invoice-checkbox"
                                                        id="tbl-data-invoice-print-{{ $order->id }}">
                                                    {{ $order->id }}</td>
                                                ...
                                                @can(['delete-order', 'update-order'])
                                                    <td style="display:flex; align-item:center;">
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-xs btn-danger"
                                                            ...
                                                            onclick="deleteData({{ $order->id }})"> Delete</a>
                                                        ...
                                                        <a href="javascript:void(0)" type="button" role="button"
                                                            ...
                                                            onclick="posPrintData({{ $order->id }})">Print</a>
                    ...
                    <center id="top">
                        ...
                        <div class="info">
                            <div style="display:flex; align-items:center;">
                                ...
                                <img src="{{ asset('public/images/logo-v2-01-01.png') }}" width="40px" height="25px"
                                    alt="">

                                <div style="margin-left: 15px;font-size: small">Homemade food <br>for babies by Jafrins
                                </div>
    ...
    <template class="print__template">
        <div id="invoice-POS-Multiple" class="print__body" style="position: center;">
            <center id="top" style="margin-bottom:20px">
                <div class="logo"></div>
                <div class="info">
                    <div style="display:flex; align-items:center;">

                        <img src="{{ asset('public/images/logo-v2-01-01.png') }}" width="80px" height="75px"
                            alt="">

                        <div style="margin-left: 15px;font-size: 16px">Homemade food <br>for babies by Jafrin</div>
            ...
            <div id="mid">
                <div class="info">
                    ...
                    <div style="font-size: 15px"><b>Phone: </b> +88 01688-505501</div>
                    <div style="font-size: 15px"><b>Website: </b>www.jafrinshomemadefood.com</div>
                </div>
            </div>
            ...
            <div id="bot">
                ...
                <div id="print__table" style="margin-top:10px;">
                </div>
                ...
                <div id="legalcopy"style="margin-top:20px;">
                    <p class="legal" style="font-size: 15px"><strong>Thanks for your order!</strong></p>

                    <p class="legal" style="font-size: 16px; margin-bottom: 12px;">

                        Contact: 01688-505501
                    </p>
        ...
        $(document).ready(function() {
            ...
            $('#printInvoiceNew').on('click', function() {
                ...
                $('.print__body .invoice-checkbox:checked').each(function() {
                    ...
                    var invoiceData = $(this).closest('tr input').find('.tr_barcode').text();
                ...
                selectedData.forEach(function(data) {
                    ...
                    // // Sanitize the invoice number to make it a valid selector
                    // var sanitizedInvoice = data.invoice.replace(/[^a-zA-Z0-9-_]/g, '_');

                    // // Find the canvas element
                    // var barcodeCanvas = printTemplateObject.find('#print__barcode')[0];

                    // // Apply JsBarcode directly to the canvas element
                    // JsBarcode(barcodeCanvas, sanitizedInvoice);

                    var table = `<table class="service__table">`;
                    Object.entries(data).forEach(function([key, value]) {
                        if (key != 'barcode') {
                            let keyVal = key[0].toUpperCase() + key.substring(1)
                            table += `<tr class="service" style="padding:8px;">
                    ...
                    // JsBarcode("#print__barcode", data.invoice);

                    // JsBarcode("#print__barcode", "Hi!");

                    // printTemplateObject.find('#print__barcode').html(JsBarcode(data.invoice));
                    ...
                    // printTemplateObject.find('#print__barcode').empty();
            ...
            function updatePrintButtonVisibility() {
                ...
                $('#printInvoiceNew').toggle(anyChecked);
